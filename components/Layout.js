    ...
    return (
        <>
            ...
            {sideNav && (
                <div className="fixed top-0 left-0 z-30 transition duration-1000 bg-[#0000008c] w-full h-full">
                    <div className={sideNav ? "w-full h-full absolute z-40  transform  translate-x-0 " : "w-full h-full absolute z-40  transform -translate-x-full"}>
                        ...
                        <div className="w-64 z-20 absolute left-0 top-0 bg-white dark:bg-[#242526] shadow flex-col justify-between transition duration-150 ease-in-out h-full">
                            <Sidebar />
                        </div>
                    </div>
                </div>
            ...
            <div className="flex h-screen relative overflow-hidden">
                <aside className="w-52 h-screen sm:relative bg-gray-50 dark:bg-[#242526] shadow md:h-full hidden flex-col sm:flex">
                    <Sidebar />
                </aside>
